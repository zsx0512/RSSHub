...
// 1draw
router.get('/fxrmzf', lazyloadRouteHandler('./routes/fxrmzf/index'));

router.get('/fxhsgg', lazyloadRouteHandler('./routes/fxhsgg/index'));
router.get('/xiyuge', lazyloadRouteHandler('./routes/xiyuge/index'));
